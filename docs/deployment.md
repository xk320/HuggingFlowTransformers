...
- Linux x86_64 包名：`HuggingFlowTransformers-linux-x86_64-v1.7.3.tar.gz`
...
HuggingFlowTransformers Gateway v1.7.3
```
...
- 客户端安装完成并输出 `HuggingFlowTransformers v1.7.3`。
...
- Gateway 一键部署输出 `HuggingFlowTransformers Gateway v1.7.3`。
